...
const CarWashDwarka = () => {
  ...
  const whyChooseUs = [
    { icon: Users, text: "Local team that works directly with customers" },
    { icon: Shield, text: "Polite, careful staff who know what they're doing" },
    { icon: Clock, text: "No rushing through jobs" },
    { icon: Sparkles, text: "Consistent cleaning quality every time" },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <Helmet>
        ...
        <meta name="description" content="Looking for a Professional car wash in Dwarka, West Delhi? CleanCruisers offers doorstep car cleaning near you. Book today for easy and reliable service." />
        <meta name="keywords" content="car wash in Dwarka, car wash near me Dwarka, car cleaning Dwarka Delhi, doorstep car wash Dwarka, car wash at home Dwarka, CleanCruisers" />
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-green-400 text-sm font-medium">Serving Dwarka & Nearby Areas</span>
            </motion.div>

            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Car Wash in Dwarka
              <span className="block text-green-400 mt-2">Trusted Local Service</span>
            </h1>

            <p className="text-gray-400 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed mb-8">
              Anyone living in Dwarka knows how quickly a car gets dirty. A short drive, parked under a tree, 
              or even standing still for a day is enough. <span className="text-white font-medium">CleanCruisers</span> was 
              started for this exact reason – we clean cars at your location and take the time needed to do it properly.
            </p>
          ...
          >
            <div>
              ...
              <div className="space-y-4 text-gray-400 text-sm sm:text-base leading-relaxed">
                <p>
                  CleanCruisers came out of everyday problems we faced ourselves. Getting a car cleaned 
                  in Dwarka often meant delays or half-done work.
                </p>
                <p>
                  We work locally and most of our customers are from nearby sectors. They call us again 
                  because we reach on time, treat their cars with care, and don't rush through the cleaning.
                </p>
                <p>
                  We understand local conditions – <span className="text-green-400">dusty roads</span>, 
                  <span className="text-green-400"> limited water supply</span>, and 
                  <span className="text-green-400"> parking challenges</span> – so our cleaning method 
                  suits real Dwarka homes and societies.
                </p>
              </div>
            </div>
              ...
              <div className="relative space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Across Dwarka sectors</p>
                  </div>
                </div>
                <p className="text-gray-400 text-sm italic border-l-2 border-green-500/50 pl-4">
                  "Many of our customers book us again because they are happy with the results, 
                  not because of big promises."
                </p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
              Our Car Wash & Cleaning Services
            </h2>
          ...
          >
            If you are searching for a <span className="text-green-400 font-medium">car wash at home in Dwarka</span>, 
            our team brings the tools and cleaning material needed to do the job properly at your place.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 px-4 bg-gradient-to-b from-gray-900/50 to-black">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mt-2 mb-4">
              Why Choose CleanCruisers in Dwarka
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              CleanCruisers is not a chain or call-centre service. We are a local team that works directly with customers.
            </p>
          </motion.div>
          ...
          >
            People choose us for convenience, honest service, and consistent cleaning quality. 
            If you want a dependable <span className="text-green-400 font-medium">car cleaning service in Dwarka Delhi</span>, 
            we aim to meet that expectation every time.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white">
                Doorstep Car Wash Services Across Dwarka
              </h2>
            </div>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Most of our work happens around Dwarka itself. We clean cars daily in nearby sectors 
              and areas around Dwarka Mor.
            </p>
          </motion.div>
          ...
          >
            <p className="text-gray-300 text-sm sm:text-base mb-6">
              Many customers come to us after trying to find a car wash close to home, especially when they 
              don't want to drive far. Once they book, we handle the service without delays and cover nearby sectors as well.
            </p>
          ...
          >
            ...
            <div className="relative p-8 sm:p-12 text-center">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
                Book Your Car Cleaning with CleanCruisers
              </h2>

              <p className="text-gray-300 text-sm sm:text-base mb-8 max-w-xl mx-auto">
                If you don't feel like driving to a service station just to get your car cleaned, 
                we can take care of it at your place. The work is done properly and without confusion.
              </p>
